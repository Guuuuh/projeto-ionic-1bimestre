...
import { IonReorderGroup, ItemReorderEventDetail, NavController, PopoverController } from '@ionic/angular';
...
export class HomePage {
  ...
  public removeAllFilmeAss(){
    this.filmesAss.forEach((filmes:any) => {
      filmes.adicionado = false
      this.filmesAss = [];
    });
  }

  public detalheFilmes(filme:any){
    this.navCtrl.navigateForward('detalhes', {queryParams: {filme: filme}});
  }

  maskSinopse(sinopse:string, limit:number){
    return sinopse.substring(0, limit) + '...';
  }
